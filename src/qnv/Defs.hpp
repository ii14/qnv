...
struct HlGroup
{
  ...
  {
    return a.mBgColor == b.mBgColor && a.mFgColor == b.mFgColor && a.mSpColor == b.mSpColor
        && a.mAttrs == b.mAttrs && a.mHlBlend == b.mHlBlend;
  }

  friend bool operator!=(const HlGroup& a, const HlGroup& b) { return !(a == b); }
};
